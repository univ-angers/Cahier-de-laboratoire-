    ...
    <div class="row ">
       <form method="post" action="profil">
            <div class="form-row">
                <div class="col">
                	 <p> Nom : </p>
                     <input id="nom" name="nom" type="text" class="form-control" value = " ${sessionScope.sessionUtilisateur.nom} "/>
                     <span class="erreur">${form.erreurs['nom']}</span>
                </div>
                <div class="col">
                 	<p> Prénom : </p>
                    <input id="prenom" name="prenom" type="text" class="form-control" value="${sessionScope.sessionUtilisateur.prenom}"/>
            ...
            <div class="form-row">
            	<div class="col mt-3 mb-3">
            	    <p> Email : </p>
                	<input id="email" type="text" name="email" class="form-control" placeholder="Email" value="${sessionScope.sessionUtilisateur.email}"/>
                 	<span class="erreur">${form.erreurs['email']}</span>
            	</div>
            </div>
            
            <div class="mt-5 mb-3">
                <button id="loginButton" class="btn-lg btn-primary" type="submit">Modifier</button>
            </div>
